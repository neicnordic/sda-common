...
func TestDefaultResponse(t *testing.T) {
	msg := []byte("foo")
	err := ValidateJSON("file://noSchema.json", msg)
...
func TestValidateJSONDatasetMapping(t *testing.T) {
	...
	err := ValidateJSON("file://schemas/federated/dataset-mapping.json", msg)
	assert.Nil(t, err)
...
func TestValidateJSONInboxRemove(t *testing.T) {
	...
	msg, _ := json.Marshal(okMsg)
	err := ValidateJSON("file://schemas/federated/inbox-remove.json", msg)
	assert.Nil(t, err)
...
func TestValidateJSONInboxRename(t *testing.T) {
	...
	msg, _ := json.Marshal(okMsg)
	err := ValidateJSON("file://schemas/federated/inbox-rename.json", msg)
	assert.Nil(t, err)
...
func TestValidateJSONInboxUpload(t *testing.T) {
	...
	msg, _ := json.Marshal(okMsg)
	err := ValidateJSON("file://schemas/federated/inbox-upload.json", msg)
	assert.Nil(t, err)
...
func TestValidateJSONInfoError(t *testing.T) {
	...
	msg, _ := json.Marshal(okMsg)
	err := ValidateJSON("file://schemas/federated/info-error.json", msg)
	assert.Nil(t, err)
...
func TestValidateJSONIngestionAccessionRequest(t *testing.T) {
	...
	msg, _ := json.Marshal(okMsg)
	err := ValidateJSON("file://schemas/federated/ingestion-accession-request.json", msg)
	assert.Nil(t, err)
...
func TestValidateJSONIngestionAccession(t *testing.T) {
	...
	msg, _ := json.Marshal(okMsg)
	err := ValidateJSON("file://schemas/federated/ingestion-accession.json", msg)
	assert.Nil(t, err)
...
func TestValidateJSONIngestionCompletion(t *testing.T) {
	...
	msg, _ := json.Marshal(okMsg)
	err := ValidateJSON("file://schemas/federated/ingestion-completion.json", msg)
	assert.Nil(t, err)
...
func TestValidateJSONIngestionTrigger(t *testing.T) {
	...
	msg, _ := json.Marshal(okMsg)
	err := ValidateJSON("file://schemas/federated/ingestion-trigger.json", msg)
	assert.Nil(t, err)
...
func TestValidateJSONIngestionUserError(t *testing.T) {
	...
	msg, _ := json.Marshal(okMsg)
	err := ValidateJSON("file://schemas/federated/ingestion-user-error.json", msg)
	assert.Nil(t, err)
...
func TestValidateJSONIngestionVerification(t *testing.T) {
	...
	msg, _ := json.Marshal(okMsg)
	err := ValidateJSON("file://schemas/federated/ingestion-verification.json", msg)
	assert.Nil(t, err)
...
func TestValidateJSONIsloatedDatasetMapping(t *testing.T) {
	...
	msg, _ := json.Marshal(okMsg)
	err := ValidateJSON("file://schemas/isolated/dataset-mapping.json", msg)
	assert.Nil(t, err)
...
func TestValidateJSONIsloatedIngestionAccession(t *testing.T) {
	...
	msg, _ := json.Marshal(okMsg)
	err := ValidateJSON("file://schemas/isolated/ingestion-accession.json", msg)
	assert.Nil(t, err)
...
func TestValidateJSONIsolatedIngestionCompletion(t *testing.T) {
	...
	msg, _ := json.Marshal(okMsg)
	err := ValidateJSON("file://schemas/isolated/ingestion-completion.json", msg)
	assert.Nil(t, err)
